...
export const COLLECTION_CARD_SELECT =
  'id, game, card_name, set_name, card_number, quantity, is_foil, is_published, price_reference, price_reference_currency, image_url, folder_id, created_at, pokemon_cards(tcgplayer_normal_market, tcgplayer_foil_market), magic_cards(tcgplayer_normal_market, tcgplayer_foil_market)';
